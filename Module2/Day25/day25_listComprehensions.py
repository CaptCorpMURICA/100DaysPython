...
#list comprehensions are a method of condensing python code into a single line
sevens_comprehension = [i for i in range(1, 101) if i % 7 == 0]
print(sevens_comprehension)

#additional actions can be taken to transform the iterator during the process 
sevens_doubled = [i * 2 for i in range(1, 101) if i % 7 ==0]
print(sevens_doubled)

#list comprehensions can also be used for string functions
...
#list comprehensions can be used against tuples in a list as well
#by calling the postion in the tuple, filters and transformations can be executed
