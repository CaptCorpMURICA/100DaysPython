"""
    ...
    Description:    One of the best uses of python automation is web scraping. This opens the door for immense
                    ...
                    sites for hours to find your dream abode. Wouldn't it be easier if python did it for you?
                        i. Create a python program to scrape at least one realtor site.
                        ii. The program should accept a list of search criterion.
                        iii. The program should pull at least the address, cost, tax information, and any photos.
                        iv. The results should be written to a file and an email should be sent to confirm the number of
                           houses identified.
                        v. This should be able to able to distinguish between a new house and a house already captured
                           by the program. Only add the new houses to the file.
                        vi. Add the homes to a PowerPoint deck for easy review.
"""
